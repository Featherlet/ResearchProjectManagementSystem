<%@ Page Title="" Language="C#" MasterPageFile="~/StudentPages/StuMasterPage.master" AutoEventWireup="true" CodeFile="MidtermReport.aspx.cs" Inherits="MidtermReport" %>
        ...
        <WizardSteps>
            <asp:WizardStep ID="WizardStep1" runat="server" Title="Step 1">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label8" runat="server" Text="项目情况进展"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="TBProcess" runat="server" style="font-size: large" 
            ...
            <asp:WizardStep ID="WizardStep2" runat="server" Title="Step 2">
                <table style="width:100%;">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="完成情况预测"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="TBPredict" runat="server" Height="200px" 
                                style="font-size: large" TextMode="MultiLine" Width="240px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
