<%@ Page Title="" Language="C#" MasterPageFile="~/StudentPages/StuMasterPage.master" AutoEventWireup="true" CodeFile="FinalPlan.aspx.cs" Inherits="FinalPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <tr>
    <td style="text-align: center" bgcolor="#DEDEE9">
        <br />
        <asp:Label ID="Label2" runat="server" Text="结题考核信息" 
