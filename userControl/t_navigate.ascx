<%@ Control Language="C#" AutoEventWireup="true" CodeFile="t_navigate.ascx.cs" Inherits="userControl_t_navigate" %>
				...
				<td style="width: 154px">
					<div class="sec_menu" id="menu1" style="WIDTH: 158px">
						<table cellSpacing="0" cellPadding="0" width="140" align="center" border="0">
							...
							<tr>
								<td height="20"><A href="TeacherMain.aspx" target="right">个人信息</A>
								</td>
							</tr>
                            <tr>
								<td height="20"><A href="TChangeInfo.aspx" target="right">修改信息</A>
								</td>
							</tr>
						</table>
					</div>
				...
				<td style="width: 165px">
					<div class="sec_menu" id="menu2" style="WIDTH: 158px">
						<table cellSpacing="0" cellPadding="0" width="140" align="center" border="0">
							...
							<tr>
								<td height="20"><A href="BasicInformation.aspx" target="right">基本信息查询</A>
								</td>
							</tr>
							
							<tr>
								<td height="20"><A href="CheckFinance.aspx" target="right">经费查询</A>
								</td>
							</tr>
				...
				<td>
					<div class="sec_menu" id="menu3" style="WIDTH: 158px">
						<table cellSpacing="0" cellPadding="0" width="140" align="center">
							...
							<tr>
								<td height="20"><A href="ApplyFinance.aspx" target="right">填写申请表</A>
                                </td>
							</tr>
						</table>
					</div>
			...
			<tr>
				<td>
					<div class="sec_menu" id="menu4" style="WIDTH: 158px">
						<table cellSpacing="0" cellPadding="0" width="140" align="center">
							<tr>
								<td height="20"><A href="CommonPlan.aspx" target="right">评审安排</A></td>
							</tr>
							<tr>
								<td height="20"><A href="FillCommon.aspx" target="right">评审填写</A></td>
							</tr>
						</table>
					</div>
				</td>
