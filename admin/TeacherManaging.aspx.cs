...
public partial class TeacherManaging : System.Web.UI.Page
{
    ...
    protected void addConfirm_Click(object sender, EventArgs e)
    {
        ...
        String shenfen = Shenfeninput.Text.ToString();
        String mail = TMail.Text.ToString();
        String department = Tdepartment.Text.ToString();
        String tel = Ttel.Text.ToString();
        String sql = ConfigurationManager.ConnectionStrings["ProjectSystemConnectionString2"].ToString();
        SqlConnection conn = new SqlConnection(sql);
        conn.Open();
        String search = "select * from Teachers where TchrId='" + id + "'";
        ...
        {
            String insert = "insert into Teachers values('" + id + "','" + name + "','" + department + "','"+mail+"','"+shenfen+"','"+tel+"')";
            ...
            Response.Redirect("TeacherManaging.aspx");
